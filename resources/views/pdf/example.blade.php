...
@foreach ($certificate as $item)
  ...
  <head>
    <title> Paz y Salvo - {{ $item->control_number }} </title>
    <style>
      @font-face {
        font-family: 'Poppins';
        font-style: normal;
            ...
            <tr>
              <td colspan="2">
                <p class="contenido">La Autoridad de Aseo Urbano y Domiciliario de Panamá certifica que el cliente
                  identificado
                  con número de <strong>NIC: 123456</strong>, perteniciente a la finca
                  <strong>{{ $item->finca }}</strong>,
                  ubicada en
                  <strong>{{ $item->address }}</strong>, corregimiento de <strong>{{ $item->town }}</strong>, distrito
                  de
            ...
            <tr>
              ...
              <td>
                <table style="border-radius: 10px">
                  <tr>
                    <td style="border: 1px solid black; border-radius: 10px">Este Paz y Salvo no es válido sin sello de
                      la institución.
                    </td>
                  </tr>
                </table>
